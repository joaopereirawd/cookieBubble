					...
					$("body").append(
						'<div class="cookieBubble '+box_visibility+ ' bottom-left">'+
							'<div class= "cb-wrapper">'+
								'<div class="cb-row">'+
									'<div class="cb-image">'+box_iconVisibility+'</div>'+
